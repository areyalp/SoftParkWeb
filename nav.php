<nav class="navbar navbar-light bg-faded">
  ...
  <div class="collapse navbar-toggleable-md" id="navbarResponsive">
    <a class="navbar-brand" href="principal.php"><img src="images/logo.png" width="114" height="50" class="d-inline-block align-top" alt="SoftPark"></a>
    <ul class="nav navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="responsiveNavbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Administracion</a>
	...
	<a class="nav-item nav-link float-xs-right" href="logout.php">Cerrar Sesion</a>
  </div>
</nav>